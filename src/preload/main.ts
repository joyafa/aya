...
export default Object.assign(mainObj, {
  ...
  createFile: invoke<IpcCreateFile>('createFile'),
  copyDir: invoke<IpcCopyDir>('copyDir'),
  ...
  pauseTransfer: invoke<IpcPauseTransfer>('pauseTransfer'),
  resumeTransfer: invoke<IpcResumeTransfer>('resumeTransfer'),
